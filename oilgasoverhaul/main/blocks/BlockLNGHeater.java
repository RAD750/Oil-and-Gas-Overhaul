...
public class BlockLNGHeater extends BlockContainer {

	ForgeDirection dir;
	String blockName;
	float hardness;	
	
	protected BlockLNGHeater(int par1, int par2, Material par3Material, String blockName, float hardness) {
	...
	public TileEntity createNewTileEntity(World var1) {
		return new TileEntityLNGHeater();
	}
