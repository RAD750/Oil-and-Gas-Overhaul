...
import oilgasoverhaul.main.solid.models.ModelLNGHeater;

import org.lwjgl.opengl.GL11;


public class RenderTableLNGHeater extends TileEntitySpecialRenderer {
	private ModelLNGHeater LNGHeater;

	public RenderTableLNGHeater() {
		LNGHeater = new ModelLNGHeater();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		bindTextureByName("/oilgasoverhaul/textures/lngHeater.png");
		LNGHeater.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
