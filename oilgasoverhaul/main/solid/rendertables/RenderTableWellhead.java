...
import oilgasoverhaul.main.solid.models.ModelWellhead;

import org.lwjgl.opengl.GL11;


public class RenderTableWellhead extends TileEntitySpecialRenderer {
	private ModelWellhead Wellhead;

	public RenderTableWellhead() {
		Wellhead = new ModelWellhead();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float scale) {
		...
		bindTextureByName("/oilgasoverhaul/textures/WellHead.png");
		Wellhead.render((Entity) null, 0.0F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0625F);
