...
public class ClientProxy extends CommonProxy {
	...
	public void init(FMLInitializationEvent event) {
		...
		//Gas di città
		TextureFXHelper.defineTextureFX(140, 150, 140, 150, 140, 145, 18);
		//Acido fosforico
		TextureFXHelper.defineTextureFX(140, 150, 160, 170, 210, 240, 19);
		//CO2
		TextureFXHelper.defineTextureFX(230, 235, 230, 235, 230, 235, 20);
		//Argon
		TextureFXHelper.defineTextureFX(230, 235, 230, 235, 230, 235, 21);
		//SF6
		TextureFXHelper.defineTextureFX(250, 250, 250, 250, 0, 0, 22);
		//Propylene
		...
		//TFE
		TextureFXHelper.defineTextureFX(251, 254, 240, 246, 210, 214, 35);
		//glicole etilenico
		TextureFXHelper.defineTextureFX(251, 254, 240, 246, 210, 214, 36);
		//ossido di etilene
		TextureFXHelper.defineTextureFX(251, 254, 240, 246, 210, 214, 37);
		//cicloesano
		TextureFXHelper.defineTextureFX(251, 254, 240, 246, 210, 214, 38);
		//cicloesanone
		TextureFXHelper.defineTextureFX(251, 254, 240, 246, 210, 214, 39);
